...
void loop() {
  ...
  if (type == 1) { //DualShock Controller
    ...
    /*ANALOG*/
    if (ps2x.Analog(PSS_LX) == 123 && ps2x.Analog(PSS_LY) == 0 ) //up
    {
      mySerial.print('g');
    ...
    if (ps2x.Analog(PSS_LX) == 123 && ps2x.Analog(PSS_LY) == 255 ) //down
    {
      mySerial.print('k');
    ...
    if (ps2x.Analog(PSS_LX) == 255 && ps2x.Analog(PSS_LY) == 123 ) //kanan
    {
      mySerial.print('i');
    ...
    if (ps2x.Analog(PSS_LX) == 0 && ps2x.Analog(PSS_LY) == 123 ) //kiri
    {
      mySerial.print('m');
    ...
    /*SERONG*/
    if (ps2x.Analog(PSS_LX) < 123 && ps2x.Analog(PSS_LY) < 123 ) //upleft
    {
      mySerial.print('n');
    ...
    if (ps2x.Analog(PSS_LX) > 123 && ps2x.Analog(PSS_LY) > 123 ) //downright
    {
      mySerial.print('j');
    ...
    if (ps2x.Analog(PSS_LX) > 123 && ps2x.Analog(PSS_LY) < 123 ) //upright
    {
      mySerial.print('h');
    ...
    if (ps2x.Analog(PSS_LX) < 123 && ps2x.Analog(PSS_LY) > 123 ) //downleft
    {
      mySerial.print('l');
  ...
  /* if (ps2x.Analog(PSS_RX) == 255 && ps2x.Analog(PSS_RY) == 123 ) //PUTAR KANAN
      mySerial.write('f');
      
    if (ps2x.Analog(PSS_RX) == 0 && ps2x.Analog(PSS_RY) == 123 ) //PUTAR KIRI
      mySerial.write('p');*/
