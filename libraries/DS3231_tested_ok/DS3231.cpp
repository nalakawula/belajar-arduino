...
char *DS3231::getDOWStr(uint8_t format)
{
	...
	//add by sumar
	char *daysLong[]  = {"Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"};
	char *daysShort[] = {"Sen", "Sel", "Rab", "Kam", "Jum", "Sab", "Ming"};
	//end by sumar
...
char *DS3231::getMonthStr(uint8_t format)
{
	...
	char *monthShort[] = {"Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des"};
	//end by sumar
